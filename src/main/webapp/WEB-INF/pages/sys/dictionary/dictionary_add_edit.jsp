...
<form class="layui-form" lay-filter="form_add_edit">
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-block"  style="width: 300px;">
				...
				<input name="dictInfo" lay-verify="required|checkdictInfo" id="dictInfo" class="layui-input check-unique" placeholder="请输入字典描述" autocomplete="off">
			</div>
		</div>
		<div class="layui-inline">
			...
			<div class="layui-input-block"  style="width: 300px;">
				<!-- lay-verify 这个layui的自定义属性 ，设置表单的校验，多个校验 用 ‘|’ 隔开  -->
				<!-- class ='check-unique' 放置在此处用于通用JS脚本修改的时候使用-->
				<input name="dictValue" lay-verify="required" id="dictValue" class="layui-input " placeholder="请输入字典的值" autocomplete="off">
			</div>
		</div>
	...
	<div class="layui-form-item">
		<div class="layui-input-block">
			<button class="layui-btn" lay-submit lay-filter="but_dictionary_submit">提交</button>
