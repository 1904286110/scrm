...
<head>
    ...
    <link rel="stylesheet" href="assert/layui/lib/layui-v2.5.5/css/layui.css" media="all">
    <!--[if lt IE 9]>
...
<script src="assert/layui/lib/jquery-3.4.1/jquery-3.4.1.min.js" charset="utf-8"></script>
<script src="assert/layui/lib/layui-v2.5.5/layui.js" charset="utf-8"></script>
<script src="assert/layui/lib/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<!-- 引入自定义的JS脚本 -->
